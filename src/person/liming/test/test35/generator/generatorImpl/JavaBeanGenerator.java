 ...
 */
public class JavaBeanGenerator implements BeanGenerator {
    ...
    public void generateBean(Table table) throws IOException {
        ...
        //生成类头
        writer.write(generateBeanClassHead(table.getTableName()));
        writer.write("\n");
        writer.newLine();
    ...
    //生成类头
    @Override
    public String generateBeanClassHead(String tableName){
